...
import {
	ContactPasswordInfo,
	ContactSecurityInfo,
	ContactSecurityProps as Props,
} from '../../Registration/ContactSecurity/ContactSecurity.types';
...
const ContactSecuritySSO: React.FC<Props> = (props) => {
	...
	if (elegibilityData?.city) {
		...
		if (elegibilityData.homePhone)
			setValue('homePhone', formatPhone(elegibilityData.homePhone));
			...
			<View style={{ alignItems: 'center' }}>
				<View style={{ alignItems: 'center', marginTop: 32 }}>
					<ContactAndSecurity
						...
						handleNext={
							statusMaintenance == 'in_maintenance' ? () => openwarning() : handleNext
						}
					/>
				</View>
			</View>
