	...
	return (
		<View style={styles.container}>
			<Text style={styles.title} maxFontSizeMultiplier={1.3}>
				{values.hadSanitas == 1 && values.type == 1
					? t('createAccount.titlesContactSecurity.contactAndSecurity')
					: values.hadSanitas == 1 && values.type == 2
					? t('createAccount.titlesContactSecurity.password')
					: values.hadSanitas == 2
					? t('createAccount.titlesContactSecurity.createAccount')
					: ''}
			</Text>
