...
export const generalAuthApi = createApi({
	...
	endpoints: (build) => ({
		maintenance: build.mutation<any, any>({ query: () => GeneralConfig.maintenance() }),
	})
});

const GeneralServiceAuth = generalAuthApi;
export default GeneralServiceAuth;