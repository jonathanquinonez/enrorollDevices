...
import fshConfig, { mentalHealthEndpoint, Object } from '../../infrastructure/keraltyApi/repositories/fshConfig';


export const fshApi = createApi({
	...
	reducerPath: 'fshApi',
	endpoints: (build) => ({
		sendForm: build.mutation<any, Object>({
			query: (body) => fshConfig.sendMail(body)
		})		
	})
});
const fshService = fshApi;
export default fshService;
