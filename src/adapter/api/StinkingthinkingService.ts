...
import stinkingConfig, { stinkingEndpoint } from 'infrastructure/keraltyApi/repositories/stinkingConfig';


export const stinkingApi = createApi({
	baseQuery: axiosBaseQuery({
		baseUrl: `${appConfig.API_URL}/${stinkingEndpoint}`,
	...
	reducerPath: 'stinkingApi',
	endpoints: (build) => ({
		getStinkingCard: build.mutation<any, object>({
			query: () => stinkingConfig.getStinkingCards()
		}),
	})
});
const stinkingService = stinkingApi;
export default stinkingService;
